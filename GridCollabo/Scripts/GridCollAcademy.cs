...
public class GridCollAcademy : Academy
{
    [HideInInspector]
    ...
    public void SetEnvironment()
    {
        ...
        agentCam.orthographicSize = (2*(float)resetParameters["sightSize"] + 1f)/2f;
        //agentCam.orthographicSize = (gridSize) / 2f;
        //agentCam.transform.position = new Vector3(0, 5, 0); //new Vector3((gridSize - 1) / 2f, gridSize + 1f, (gridSize - 1) / 2f);
    ...
    public int removeGoal(GameObject Goal)
    {
